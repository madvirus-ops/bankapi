...
Revision ID: a1dc3babe333
Revises: 00b9547c4426
Create Date: 2023-02-10 13:32:44.176808
...
revision = 'a1dc3babe333'
down_revision = '00b9547c4426'
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    ...
    sa.Column('network_name', sa.VARCHAR(), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
